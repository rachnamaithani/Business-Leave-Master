...
if(isset($_REQUEST['submit_btn'])){
  ...
  $password = $_POST['password'];
   ...
   $select = "SELECT * FROM `adminlogin` WHERE `email`='$email' AND `password`='$password'";
...
<section class="vh-75">
  <div class="container w-75" style="height: 550px;">
    <div class="row d-flex justify-content-center align-items-center logincontainer bg-white h-100 m-5">
      <div class="col-5">
        <div class="card shadow-2-strong logincard" style="border: none;">
          <div class="card-body p-5 text-center position-relative">
            <img src="images/admin.png" alt="adminlogo" height="80px" width="80px" class="admin-pic position-absolute">
            <h4 class="mb-5 mt-3">Admin Log In</h4>
            <form method="post">
      ...
      <div class="col-5">
        <img src="images/adminloginimg.png" alt="img" width="100%">
      </div>
    </div>
  </div>
</section>
